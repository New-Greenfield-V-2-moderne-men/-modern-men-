...
export default function cart() {   
    ...
    useEffect(()=>{   
        ...
        axios.get(`http://localhost:4000/users/getOne/${id}`) 
 ...
 const deleteOne =(productId)=>{  
   if (typeof window !== 'undefined') {
        const id = localStorage.getItem('USER_ID')     
        axios.put(`http://localhost:4000/users/deleteCart/${id}`,{id : productId}) 
 ...
 const deleteAll =()=>{  
  if (typeof window !== 'undefined') {
       const id = localStorage.getItem('USER_ID')     
       axios.put(`http://localhost:4000/users/deleteAll/${id}`) 
